const HistoryPageSkeleton = () => {
    return (
        <div className='z-10 w-full h-full mt-26'>
          ...
          <div className='z-10 mt-4 ml-6 flex gap-4 overflow-x-auto pr-6'>
            {Array.from({ length: 5 }).map((_, i) => (
              <div
                key={i}
                className='w-[180px] h-[270px] rounded-lg bg-gray-800 animate-pulse flex-shrink-0'
              />
            ))}
          </div>
          ...
          <div className='z-10 flex justify-between items-end mt-6'>
            <h1 className='z-10 mt-12 text-2xl font-semibold ml-6 text-white'>
