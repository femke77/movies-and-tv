      ...
      >
        ...
        <div className="max-w-[1800px] mx-auto relative h-full z-0">
          ...
          >
            ...
            <div
              className={clsx(
                `flex flex-col ${width < 950 ? "items-center" : "items-start"}`
              )}
            >
          ...
          <div
            className={clsx(
              `absolute right-0 top-1/2 transform -translate-y-1/2 mr-16 md:mr-20 lg:mr-40 mt-5 ${
          ...
          >
            {slide.poster_path && (
              ...
              <img
                className={`w-78 h-auto rounded-lg object-cover transition-opacity duration-500 ${
...
// const UserRating = React.lazy(() => import("../UserRating"));
// const WatchButton = React.lazy(() => import("../WatchButton"));
...
//   movieList: IItem[];
// }) => {
//   // Loading states - directly using useState for each element
...
//   // Track when critical elements are loaded
...
//       // Load poster image - only if poster path exists
...
//         {/* Slide Content - only appears when critical elements are loaded */}
//         <div
...
//           {/* Left content */}
//           <div
//             className={clsx(`w-full md:w-1/2 absolute flex flex-col px-16 md:px-18 lg:px-26 xl:ml-10 z-5
//               ${
//                 width < 950
//                   ? "w-full h-full justify-center mt-5"
//                   : "w-1/2 top-1/2 transform -translate-y-1/2 mt-5"
//               }`)}
//           >
//             {/* Genre and date section - fixed height to prevent layout shifts */}
//             <div
//               className={clsx(`flex flex-col h-[30px] ${
//                 width < 950 ? "items-center" : "items-start"
//               }`)}
//             >
//               <div className={`flex justify-start items-start mb-6 pb-6`}>
...
//                 <p className="text-white font-light ml-4">
//                   {slide.media_type === "movie"
//                     ? slide.release_date && formattedMovieDate !== "Invalid Date"
//                       ? formattedMovieDate
//                       : null
//                     : null}
//                 </p>
...
//             {/* Content container */}
//             <div className="flex flex-col">
//               {/* Title/logo section - fixed height container */}
//               <Link to={`/${slide.media_type}/${slide.id}`} className="block">
//                 <div
//                   className={`flex flex-col ${
//                     width < 950 ? "items-center" : "items-start"
...
//                 <div className="mb-2">
//                   {contentLoaded ? (
//                     <Suspense fallback={<div className="w-12 h-12 bg-gray-700/30 rounded-full animate-pulse"></div>}>
//                       <UserRating rating={slide.vote_average ?? 0} />
//                     </Suspense>
//                   ) : (
...
//           {/* Poster image with placeholder - fixed the poster loading issue */}
