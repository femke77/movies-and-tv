...
const Footer = () => {
  const [openSection, setOpenSection] = useState<'about' | 'discover' | 'genres' | 'legal' | null>(null);

  const toggleSection = (section: 'about' | 'discover' | 'genres' | 'legal') => {
    ...
    <footer className="border-t-gray-500 max-w-[1800px] border-t-1 mt-8 pt-6 text-center py-4 bg-black relative z-50 text-[#726c6c] text-lg">
      <div className="flex mx-10 flex-col md:flex-row md:justify-between items-top md:mx-10 md:pr-4 lg:pr-12 pb-10 lg:mx-30">
        ...
        <div className="flex flex-col items-left text-left mb-3">
          ...
          <div className={`${openSection === 'discover' ? 'block' : 'hidden'} md:flex mt-2 flex flex-col items-left text-left text-white/70 text-sm`}>
        ...
        <div className="flex flex-col items-left text-left mb-3">
          ...
          <div className={`${openSection === 'genres' ? 'block' : 'hidden'} md:flex mt-2 flex flex-col items-left text-left text-white/70 text-sm`}>
            <Link to="/explore/toprated" className="">
              Action
            </Link>
            <Link to="/explore/top-series" className="">
        ...
        <div className="flex flex-col items-left text-left mb-3">
          ...
          <div className={`${openSection === 'legal' ? 'block' : 'hidden'} md:flex mt-2 flex flex-col items-left text-left text-white/70 text-sm`}>
            <Link to="/dmca" className="">
              DMCA
            </Link>
            <Link to="https://www.themoviedb.org/terms-of-use" target="_blank" className="">
              Terms of Use
            </Link>
            <Link to="https://www.themoviedb.org/privacy-policy" target="_blank" className="">
              Privacy Policy
            </Link>
          </div>
        </div>
      ...
      <div className="text-center mt-6 border-t-gray-500 border-t-1 pt-6">
        ...
        <Link to="http://www.themoviedb.org" target="_blank" className="text-white/70 text-sm">
          <img src="/tmdb.svg" alt="The Movie Database" className="w-44 my-4 mx-auto" />
        </Link>
      </div>
    </footer>
  );
