    ...
    <footer className='border-t-gray-500 max-w-[1800px] border-t-1 mt-8 pt-6 text-center py-4 bg-black relative z-50 text-[#726c6c] text-lg'>
      <div className='flex mx-10 flex-col md:flex-row md:justify-between items-top md:mx-10 md:pr-4 lg:pr-12 pb-10 lg:mx-30'>
        ...
        <div className='flex flex-col items-left text-left md:w-1/5 mb-3'>
          ...
          <div
            className={`${openSection === 'about' ? 'block' : 'hidden'} md:block`}
          >
        ...
        <div className='flex flex-col items-left text-left mb-3'>
          ...
          <div
            className={`${openSection === 'discover' ? 'block' : 'hidden'} md:flex mt-2 flex flex-col items-left text-left text-white/70 text-sm`}
          >
        ...
        <div className='flex flex-col items-left text-left mb-3'>
          ...
          <div
            className={`${openSection === 'genres' ? 'block' : 'hidden'} md:flex mt-2 flex flex-col items-left text-left text-white/70 text-sm`}
          >
            <Link to='/explore/toprated' className=''>
              Action
            </Link>
        ...
        <div className='flex flex-col items-left text-left mb-3'>
          ...
          <div
            className={`${openSection === 'legal' ? 'block' : 'hidden'} md:flex mt-2 flex flex-col items-left text-left text-white/70 text-sm`}
          >
