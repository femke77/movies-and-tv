...
const ServerButton = ({ name, value }: { name: string; value: string }) => {
  return (
    <button value={value} className="flex items-center w-full p-3 bg-gray-700/50 hover:bg-gray-700/70 rounded-lg mb-2 hover:cursor-pointer hover:translate-[1px] active:translate-[1px]">
