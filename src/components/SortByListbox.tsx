...
export default function Example({ sortByOption, setSortByOption, sortOptions }: ISortOption) {



  return (
    <div className="mb-8 w-52 mr-4 hover:translate-[1px] pt-[5px] rounded-md hover:outline-blue-700 hover:outline-1  ">
  ...
  {sortOptions.find((opt) => opt.value === sortByOption)?.name ?? "Select an option"}
          <ChevronDownIcon
