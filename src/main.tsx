    ...
    if (this.state.hasError) {
      return (
        <div className="mt-40 text-center">
          ...
          <p>The app was likely updated. Please refresh to get the latest version.</p>
          <button className='bg-gray-800/50 text-white' onClick={this.refreshPage}>Refresh Now</button>
        </div>
      );
    }
